...
const val SEARCH_BODY_LIST_CHARACTER_TAG = "SearchBodyListCharacterTag"

@Composable
fun SearchBodyListComponent(
    showLoading: Boolean,
    listCharacters: List<CharacterEntity>?,
    addCharacterButtonClick: (CharacterEntity) -> Unit,
    modifier: Modifier
            ...
            listCharacters?.let {
                LazyColumn(
                    ...
                    itemsIndexed(it) { index, item ->
                        SearchCharacterItemComponent(
                            character = item,
                            addCharacterButtonClick = addCharacterButtonClick,
                            modifier = Modifier.testTag(SEARCH_BODY_LIST_CHARACTER_TAG + index)
                        )
                    }
                }
            }
...
@Composable
fun SearchCharacterItemComponent(
...
fun SearchToolbarComponent(searchCharacterByName: (String) -> Unit, modifier: Modifier) {
    Row(
        ...
        OutlinedTextField(
            ...
            modifier = Modifier
                .fillMaxSize()
                .testTag(OUTLINE_FIELD_TEST_TAG)
        )
    }
}

@Composable
fun SearchBackgroundComponent(content: @Composable () -> Unit) {
    Box {
        Image(
